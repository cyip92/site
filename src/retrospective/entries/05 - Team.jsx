  ...
  return (
    <>
      <div>
        ...
        <div className="c-entries-columns">
          <div className="c-col-wide">
            <ul>
              ...
              <li>This is where you&apos;d get the ability to auto-filter your glyphs</li>
            ...
            ultimately settling upon a set of simple settings (effect count, rarity threshold) and a really advanced
            one (effect score, known as &quot;advanced mode&quot; at the time). Initially these were split into two
            separate upgrades, and together they were the only three modes which existed.
            <br />
            <br />
            Glyph presets didn&apos;t exist yet - those would come much later. Similarly, relic shards were
            a pure currency used only for the unlocks; the glyph rarity boost would be implemented later on.
          </div>
        ...
        <br />
        <br />
        I made the first version of this Celestial&apos;s reality, and a lot stayed largely unchanged until release
        (only numerical tweaks). I was never really satisfied with how this reality turned out and hoped I would
        ...
        multiplier, infinity count multiplier, or Theorem generation.
        <br />
        <br />
        ...
        stored time (a mechanic from the next Celestial). It would be some time until we revisited this idea properly.

        <h3>A bit of &quot;drama&quot;</h3>
        (Put away the popcorn, please.)
        <br />
        <br />
        At this point I was very heavily involved in the server community, but it was significantly smaller due to it
        being before the Android release. However, there were some (arguably) rampant spammers and immaturity which
        ...
        didn&apos;t just ignore the problem - we properly discussed it with each other so that we could move forward
        together. Quite frankly, looking back on it, it almost feels petty that I did this. Ultimately it was just a
        difference in mindset, one which we were both willing to adjust our behaviors for each other on. We&apos;ve
        been close friends since then.
        <br />
        <br />
        I returned on December 19th and, while the exact details are spread across too many places to search through,
        I was given the moderator role on the Discord server and would also act as a mod in the community as well in
        order to try to improve the state of the server.
        <br />
        <br />
        Around this time Dan left the server temporarily as well, but for other reasons - he was also involving himself
        in the community, but he started to find it too distracting and a drain on his free time. He came back after
        a month or so away though and tried to tune back his community involvement, staying in just the test channel.

        <h3>Team Development</h3>
        Hevi had a lot of other stuff going on for a bit, so Garnet and Razen were in effect the primary devs while
        all the mechanics were getting filled out. Dan also started contributing to code development as well, although
        it was largely weighted towards sanity-checking Razen&apos;s refactors and Garnet&apos;s balance changes.
        <br />
        <br />
        ...
        <br />
        <br />
        Fun fact: I&apos;m reasonably confident that most of the Antimatter Dimensions dev team (at least by now)
        didn&apos;t actually know Javascript before joining in on the code. I know I didn&apos;t, it seemed like
        Garnet and Razen didn&apos;t either, and I suspect that Dan was also the same.
        ...
        <div className="c-entries-columns">
          ...
          <div className="c-col-wide">
            ...
            in a sensible way for offline progress. Initially the black holes didn&apos;t work offline at all,
            and then were changed to just apply the average speed boost for the offline duration. Eventually he and
            Garnet discussed the details a bunch and he drafted up the first version of splitting up offline ticks
            so that they would give similar results to leaving the game open.
          </div>
        </div>

        <h3>Not Very Robust</h3>
        Dan and Garnet were seeing inconsistency with the game behavior, having to do with intermittent huge
        ...
        <br />
        <br />
        At this time there was a large push to simplify the player object as much as possible, since there were many
        ...
        <br />
        <br />
        Dan saw some effects becoming problematically big in the future - he was very good at noticing ahead of time
        ...
        Hevi pitched the idea of allowing you to restart the game with a very minor New Game Plus or New Game Minus
        ...
        actually being implemented at this point yet, but it did exist temporarily and came up in conversation
        somewhat regularly in the future.
        <br />
        <br />
        ...
        own code to spare the time to test either. There were also no gameplay images posted of the content either,
        and the code no longer exists on the repository since it was never actually merged into the main branch.
        <br />
        <br />
        My best guess on how it worked (from messages in the channel) is that it was another very heavily-nerfed
        reality, except there were numerous special upgrades which were only obtainable within. All of these upgrades
